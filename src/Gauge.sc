...
;;;		higher {up}			;text for the 'increase value' button ;ENGLISH
;;;		lower {down}		;text for the 'decrease value' button ;ENGLISH
		higher {up}			;text for the 'increase value' button ;SPANISH UP GOOD
		lower {down}		;text for the 'decrease value' button ;SPANISH DOWN GOOD
