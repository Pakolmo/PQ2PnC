...
;;;			(code doit: temp0)
			...
			(DrawStatus (Format @str {_PQ2_Point_and_Click________Score: %d of %d} score possibleScore))
;;;			(DrawStatus (Format @str {_PQ2_Point_and_Click________Puntuaci/n:_%d_de_%d_} score possibleScore))
